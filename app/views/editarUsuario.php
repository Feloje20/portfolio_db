...
<body>
    ...
    <form class="registerForm" action="" method="post" enctype="multipart/form-data">
        ...
        <!-- Solo mostramos este campo si el usuario ya ha creado su portfolio-->
        <?php if ($data['isPortfolioCreated'] == 1) { ?>
            <label for="isVisible">portfolio visible al público:
                <input type="checkbox" id="isVisible" name="isVisible" value="1" <?php echo $data['visible'] == 1 ? 'checked' : ''?>>
            </label><br>
        <?php } ?>
